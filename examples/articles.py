...
from stroeer.core.v1.core_article_service_pb2 import BatchGetArticlesRequest, BatchGetArticlesResponse
...
def handler():
    ...
    with grpc.secure_channel(os.getenv('GRPC_ENDPOINT'), ssl) as channel:
        ...
        response: BatchGetArticlesResponse = stub.BatchGetArticles(
            request=BatchGetArticlesRequest(ids=[92355698, 92364708, 92362228]),
            metadata=metadata)
