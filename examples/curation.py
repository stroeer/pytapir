...
from stroeer.curation.v1.core_curation_service_pb2 import BatchGetCurationRequest, BatchGetCurationResponse
from stroeer.curation.v1.core_curation_service_pb2_grpc import CurationServiceStub
